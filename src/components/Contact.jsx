...
function Contact() {
  return (
    <section id="contact" className="bg-slate-50 py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 sm:mb-10 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-premiumBlue md:text-5xl">Contact Us</h2>
          ...
          >
            {[
              ...
              return (
                <div
                  key={item.title}
                  className="flex items-start gap-3 sm:gap-4 rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-3 sm:p-5 shadow-soft transition hover:-translate-y-1 hover:shadow-glow"
                >
                  <span className="flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-lg sm:rounded-xl bg-premiumGold/15 text-premiumGold shrink-0">
                  ...
                  <div className="min-w-0">
                    ...
                    {item.link ? (
                      <a
                        href={item.link}
                        className="text-sm sm:text-base font-medium text-premiumBlue hover:text-premiumGold break-words"
                      >
                        {item.value}
                      </a>
                    ) : (
                      <p className="text-sm sm:text-base font-medium text-slate-700 break-words">
                        {item.value}
                      </p>
                    )}
                  </div>
