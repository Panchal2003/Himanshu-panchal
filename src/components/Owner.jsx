...
function Owner() {
  return (
    <section id="owner" className="bg-slate-50 py-12 sm:py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="mx-auto flex flex-col items-center gap-6 sm:gap-8 rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-5 sm:p-6 lg:p-8 shadow-soft lg:flex-row lg:items-start"
        >
          <div className="relative mb-4 sm:mb-6 lg:mb-0 h-36 w-36 sm:h-44 sm:w-44 overflow-hidden rounded-full border-4 border-premiumGold shadow-md">
            <img
              src="/image.png"
